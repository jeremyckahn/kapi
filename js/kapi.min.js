...
gotoAndPlay:function(a){this.gotoFrame(a);return this.play()},getNumberOfLayers:function(){return a._layerIndex.length},getState:function(){return a._currentState},bind:function(b,c){typeof b==="string"&&typeof c==="function"&&(a._events[b]||(a._events[b]=[]),a._events[b].push(c));return this},unbind:function(b,c){var d;if(typeof b==="string"&&a._events[b])if(typeof c==="function")for(d=0;d<a._events[b].length;d++)a._events[b][d]===c&&a._events[b].splice(d,1);else a._events[b]=[];return this},_expose:function(){return a}};
