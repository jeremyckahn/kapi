...
1:0;if(a._reachedKeyframes[b]!==a._keyframeIds[b])a._currentFrame=a._reachedKeyframes[b]=a._keyframeIds[b];a._currentFrame<=a._lastKeyframe&&(a.autoclear!==!1&&a.ctx.clearRect(0,0,a.el.width,a.el.height),v("enterFrame"),N(a._currentFrame));O()},1E3/a._params.fRate);return a._updateHandle}var S={fRate:20,autoclear:!0},D={},a={_events:{},_keyframeIds:[],_reachedKeyframes:[],_layerIndex:[],_keyframes:{},_actors:{},_actorstateIndex:{},_keyframeCache:{},_originalStates:{},_liveCopies:{},_currentState:{},
_animationDuration:0,_repsRemaining:-1,_lastKeyframe:void 0,_currentFrame:void 0,_loopStartTime:void 0,_startTime:void 0,_pausedAtTime:void 0,_isPaused:void 0,_isStopped:void 0,_loopLength:void 0,_loopPosition:void 0,_updateHandle:void 0,_repeatCompleteHandler:void 0,fCount:0},P=Object.prototype.toString,C=/(\+|\-|=|\*|\/)/g,J={ms:function(c){return c*a._params.fRate/1E3},s:function(c){return c*a._params.fRate}},M={"+=":function(a,b){return a+b},"-=":function(a,b){return a-b},"*=":function(a,b){return a*
b},"/=":function(a,b){return a/b}};D={init:function(c,b,d){var e,f;b=b||{};d=d||{};n(b,S);a._params=b;a.autoclear=!!a._params.autoclear;a._params.canvas=c;a.el=c;a.ctx=c.getContext("2d");for(f in d)d.hasOwnProperty(f)&&this.bind(f,d[f]);for(e in a._params.styles)if(a._params.styles.hasOwnProperty(e)){a._params.styles[e]=a._params.styles[e].toString().toLowerCase();if(e==="height"||e==="width"||e==="top"||e==="left")a._params.styles[e].match(/px/)||(a._params.styles[e]+="px");c=a.el.style;b=e;d=a._params.styles[e];
typeof d==="string"&&(d=d.replace(/\s/g,""));c[b]=d}a._params.styles&&(a._params.styles.height&&F.call(a.el,"height"),a._params.styles.width&&F.call(a.el,"width"));delete this.init;return this},getVersion:function(){return"1.0.0b3"},isPlaying:function(){return a._isStopped===!1&&a._isPaused===!1},play:function(){var c;c=+new Date;if(this.isPlaying())return this;a._isStopped=a._isPaused=!1;if(!a._startTime)a._startTime=c;a._loopStartTime?(c-=a._pausedAtTime,a._loopStartTime+=c,a._startTime+=c):(a._loopStartTime=
...
c[g]*b}return a._params.fRate},gotoFrame:function(c){var b=+new Date;this.isPlaying()&&this.stop();c=r(c)%a._lastKeyframe;a._currentFrame=c;a._loopStartTime=a._startTime=b-c*a._params.fRate;a._pausedAtTime=b;a._reachedKeyframes=a._keyframeIds.slice(0,q(a._keyframeIds));a.ctx.clearRect(0,0,a.el.width,a.el.height);N(a._currentFrame);return this},gotoAndPlay:function(a){this.gotoFrame(a);return this.play()},getNumberOfLayers:function(){return a._layerIndex.length},getState:function(){return a._currentState},
